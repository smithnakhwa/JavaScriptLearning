class Employee {
    ...
    console.log(`=========Traversing Using For Each Loop on Map===========`);
    ...
    map_employees.forEach((employeeObject,key) => {
        console.log(`${key}===> Name: ${employeeObject.emp_name}, Dept: ${employeeObject.emp_dept}, Company: ${employeeObject.emp_company}, Salary: ${employeeObject.emp_salary}`);
